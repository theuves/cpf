...
test('should format partial CNPJ in non-strict mode', t => {
  ...
  t.is(format('123', { strict: false }), '12.3')
  t.is(format('1234', { strict: false }), '12.34')
  t.is(format('12345', { strict: false }), '12.345')
  t.is(format('123456', { strict: false }), '12.345.6')
  t.is(format('1234567', { strict: false }), '12.345.67')
  t.is(format('12345678', { strict: false }), '12.345.678')
  t.is(format('123456789', { strict: false }), '12.345.678/9')
  t.is(format('1234567890', { strict: false }), '12.345.678/90')
  t.is(format('12345678901', { strict: false }), '12.345.678/901')
  t.is(format('123456789012', { strict: false }), '12.345.678/9012')
  t.is(format('1234567890123', { strict: false }), '12.345.678/9012-3')
  t.is(format('12345678901234', { strict: false }), '12.345.678/9012-34')
})

test('should handle number input in non-strict mode', t => {
  t.is(format(12345678000195, { strict: false }), '12.345.678/0001-95')
  t.is(format(1234567800019, { strict: false }), '01.234.567/8000-19')
  t.is(format(123456780001, { strict: false }), '00.123.456/7800-01')
  t.is(format(12345678000, { strict: false }), '00.012.345/6780-00')
  t.is(format(1234567800, { strict: false }), '00.001.234/5678-00')
  t.is(format(123456780, { strict: false }), '00.000.123/4567-80')
  t.is(format(12345678, { strict: false }), '00.000.012/3456-78')
  t.is(format(1234567, { strict: false }), '00.000.001/2345-67')
  t.is(format(123456, { strict: false }), '00.000.000/1234-56')
  t.is(format(12345, { strict: false }), '00.000.000/0123-45')
  t.is(format(1234, { strict: false }), '00.000.000/0012-34')
  t.is(format(123, { strict: false }), '00.000.000/0001-23')
  t.is(format(12, { strict: false }), '00.000.000/0000-12')
  t.is(format(1, { strict: false }), '00.000.000/0000-01')
  t.is(format(0, { strict: false }), '00.000.000/0000-00')
})

test('should truncate more than 14 digits in non-strict mode', t => {
  t.is(format('123456789012345', { strict: false }), '12.345.678/9012-34')
  t.is(format('123456789012345678', { strict: false }), '12.345.678/9012-34')
})
...
test('should handle CNPJ with only digits in non-strict mode', t => {
  t.is(format('12345678000195', { strict: false }), '12.345.678/0001-95')
  t.is(format('1234567800019', { strict: false }), '12.345.678/0001-9')
  t.is(format('123456780001', { strict: false }), '12.345.678/0001')
})

test('should handle CNPJ ending with separators in non-strict mode', t => {
  t.is(format('12.', { strict: false }), '12')
  t.is(format('12.345.', { strict: false }), '12.345')
  t.is(format('12.345.678/', { strict: false }), '12.345.678')
  t.is(format('12.345.678/0001-', { strict: false }), '12.345.678/0001')
})
...
test('should handle very large numbers in non-strict mode', t => {
  t.is(format(123456789012345, { strict: false }), '12.345.678/9012-34')
  t.is(format(999999999999999, { strict: false }), '99.999.999/9999-99')
})
...
test('should handle CNPJ with all zeros', t => {
  t.is(format('00000000000000', { strict: false }), '00.000.000/0000-00')
  t.is(format(0, { strict: false }), '00.000.000/0000-00')
})
